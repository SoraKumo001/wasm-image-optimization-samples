...
This is a sample of image conversion using Web Worker and Web Assembly in React Router.

https://react-router-image-convert.mofon001.workers.dev/
...
import wasmImageOptimizationPlugin from "wasm-image-optimization/vite-plugin"; // Add plugin
